      ...
      <div className="hero min-h-screen">
        <div className="hero-content text-center">
          <div className="flex flex-col items-center">
            <h1 className="text-6xl text-black mb-5 font-bold">Victory <span className="bg-[#FF0000] text-white px-4 py-1 rounded-[15px] border-4 border-dashed border-black">Production98</span></h1>
            <h1 className="text-6xl text-black mt-3 font-bold">Agency Creative Company</h1>
            <p className="py-6 text-black mt-5 text-lg">CV. SEMBILAN DELAPAN adalah agensi kreatif terpadu yang menghadirkan solusi <br /> visual dan komunikasi efektif melalui strategi, produksi, dan inovasi kreatif.</p>
