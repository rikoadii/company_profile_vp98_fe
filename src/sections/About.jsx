  ...
  return (
    <div className="py-10 md:py-20 w-full" id="about">
      <div className="container mx-auto md:px-0">
        ...
        <div className="relative z-[100] mt-[-80px] md:mt-[-350px] lg:mt-[-467px] mb-8 md:mb-16" style={{ zIndex: 100 }}>
          <ScrollAnimationWrapper animation="scroll-scale" delay={300}>
            <div className="mx-auto max-w-4xl px-0 md:px-4 relative z-[100]" style={{ zIndex: 100 }}>
              {loading ? (
                <div className="w-full h-64 bg-gray-200 animate-pulse md:rounded-tr-[30px] md:rounded-bl-[30px] relative z-[100]" style={{ zIndex: 100 }} />
              ) : error ? (
                <div className="w-full p-4 bg-red-100 text-red-600 md:rounded-tr-[30px] md:rounded-bl-[30px] flex flex-col items-center relative z-[100]" style={{ zIndex: 100 }}>
                ...
                <img
                  ...
                  className="w-full h-auto md:h-[467px] shadow-lg object-cover md:rounded-tr-[30px] md:rounded-bl-[30px] relative z-[100]"
                  style={{ zIndex: 100 }}
                  onError={(e) => {
        ...
        <div className="flex flex-col lg:flex-row gap-4 md:gap-8">
          <ScrollAnimationWrapper animation="scroll-slide-left" delay={100}>
            <div className="flex-1 mt-[-160px] md:mt-[-300px] lg:mt-[-530px] relative z-10">
              <Event />
            </div>
          </ScrollAnimationWrapper>
          <ScrollAnimationWrapper animation="scroll-slide-right" delay={300}>
